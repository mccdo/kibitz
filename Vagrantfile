...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # the file kibitz.pp in the manifests_path directory.
  #
...
#     chef.cookbooks_path = "../../praxik-chef/cookbooks"
#     chef.roles_path = "../../praxik-chef/roles"
#     chef.data_bags_path = "../../praxik-chef/data_bags"
